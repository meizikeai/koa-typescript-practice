...
const support: string[] = ['.log']
const LogFileName: string[] = ['error.log', 'warn.log', 'info.log', 'debug.log', 'trace.log']
const directory = (() => {
  let pwd = process.cwd()

  if (isPro == true) {
    pwd = '/data/logs/koa-typescript-practice'
  } else {
...
const HanldeFindFile = (directory: string) => {
  let result: string[] = []
